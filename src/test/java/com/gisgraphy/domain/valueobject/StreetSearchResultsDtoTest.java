...
public class StreetSearchResultsDtoTest {
    ...
    public void constructor(){
	 StreetDistance streetDistance = GisgraphyCommonsTestHelper.createStreetDistance();
	 Long qtime = 300L;
	...
	try {
	    ...
	    StreetSearchResultsDto streetSearchResultsDto = GisgraphyCommonsTestHelper.createStreetSearchResultsDto();
